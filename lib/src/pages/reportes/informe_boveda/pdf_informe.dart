...
Future<Uint8List> pdfInformeBoveda(List<Boveda> bovedas, List<Movimiento> movimientos) async {
            ...
            pw.Table(
              ...
              children: [
                pw.TableRow(children: [
                  ...
                  pw.Padding(padding: pw.EdgeInsets.all(2), child: pw.Text("${aperturas.last.nombreSupervisor}", style: pw.TextStyle(fontSize: 8))),
